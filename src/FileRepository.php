...
use LabbeAramis\Modules\Exceptions\InvalidAssetPath;
use LabbeAramis\Modules\Exceptions\ModuleNotFoundException;
use LabbeAramis\Modules\Process\Installer;
use LabbeAramis\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @param string $args
     * @param string $path
     * @return \LabbeAramis\Modules\Module
     */
     ...
     * @return string
     * @throws \LabbeAramis\Modules\Exceptions\ModuleNotFoundException
     */
