...
use LabbeAramis\Modules\Exceptions\LaravelModuleInstallerException;
...
class LaravelModuleInstaller extends LibraryInstaller
{
    ...
    /**
     * Get the module name, i.e. "labbearamis-module/something-module" will be transformed into "Something"
     *
